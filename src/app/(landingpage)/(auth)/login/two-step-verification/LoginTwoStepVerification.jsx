...
const LoginTwoStepVerification = () => {
    const onSubmit = (e) => {
        e.preventDefault();
    };
    return (
        <div className='p-4'>
            ...
            <p className='text-gray-500 mb-4'>******12@gmail.com</p>
            <div className='mt-4'>
                <Form validationBehavior="native" onSubmit={onSubmit}>
                    ...
                    <Button type="submit" color='primary' className='w-full my-4'>Reset Password</Button>
                </Form>
...
export default LoginTwoStepVerification