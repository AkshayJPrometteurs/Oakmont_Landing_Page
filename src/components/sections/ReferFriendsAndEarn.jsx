...
const ReferFriendsAndEarn = () => {
    return (
        <section id="download-app-section" className="px-10 py-16 md:px-32 md:py-16 grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-4 justify-center items-center bg-[#F7F7F7]">
            <div>
            ...
            <div className='text-center'>
                ...
                <p className='text-gray-500 text-xl'>Referrals Paid</p>
            </div>
        </section>
    )
}
