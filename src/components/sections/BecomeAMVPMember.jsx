...
const BecomeAMVPMember = ({isModalOpen,href}) => {
    ...
    const handlePriceDetails = (plan,price) => { setPlanName(plan); setPlanPrice(price); onOpen(); }
                ...
                <Form className={inter.className} validationBehavior="native" onSubmit={onSubmit}>
                    <div className='flex flex-col md:flex-row'>
                        ...
                        <div className='w-full md:w-2/5 px-5 py-8 text-[#707070]'>
                            ...
                            <Button type="submit" color="success" className="w-full text-white">Make A Payment</Button>
