...
const DownloadApp = () => {
    ...
    return (
        <Box sx={{ px : { xs : 8, md: 16 }, py : {xs : 5, md: 10 } }} id='download-app-section'>
            <section className='grid grid-cols-1 md:grid-cols-2 items-center' style={{ gap : '10px' }}>
                <img src="assets/images/download-app-left-image.png" alt="download-app-left-image" />
                <div>
                    <h1 className='text-3xl md:text-5xl uppercase tracking-wider leading-[1.3!important] text-center md:text-left' style={{ fontFamily : theme.typography.secondaryFont }}>Download the new
                    oakmont athletic app</h1>
                    <div className='flex flex-col md:flex-row mt-10 gap-4 items-center'>
                        <Button variant='contained' sx={{ borderRadius: '8px' }} className='h-12 w-full md:w-auto'>Download for free</Button>
                        <div className="flex flex-row gap-4 w-full md:w-auto">
                            <Button className="flex items-center justify-center w-full md:w-48 text-white bg-black h-12 rounded-xl">
                                <div className="mr-3">
