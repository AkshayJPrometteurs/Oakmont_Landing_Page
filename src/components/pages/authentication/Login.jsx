...
const Login = () => {
  ...
  return (
    <GuestLayout
      ...
      headerIcon={
        <Image src={MarketingEmoji} height={5} width={25} alt="emoji" />
      }
      headerPara={"Please sign-in to your account and start the adventure"}
      alertVisibility={{
        description: isApiErrors,
        type:
          isApiErrors ===
    ...
    >
      <Form validationBehavior="native" onSubmit={onSubmit}>
        ...
        <div className="flex justify-between items-center gap-2 sm:gap-4 mb-4 w-full">
          {/* {isRememberMe ? (
                        <Fragment>
          ...
          <Link
            ...
            className=" text-sm sm:text-base text-primaryColor "
          >
            Forget Password?
          </Link>
        </div>
      ...
      <div className="my-5 flex justify-center items-center gap-2">
        <h1 className="text-gray-500 text-sm sm:text-base">Don't have account?</h1>
        <Link href={"/signup"} className="text-primaryColor text-sm sm:text-base">
          Sign Up
        </Link>
      </div>
    </GuestLayout>
