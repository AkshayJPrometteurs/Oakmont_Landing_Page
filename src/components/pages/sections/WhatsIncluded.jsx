...
const WhatsIncluded = () => {
    const items = [
        ...
        { icon : <RiBasketballLine color='#FE7234' size={'3rem'}/>, title : 'Tournaments', description : 'Compete against the community in the fantasy tournaments for a chance to win big prizes.' },
        { icon : <TbDeviceAnalytics color='#FE7234' size={'3rem'}/>, title : 'News & Analysis ', description : 'Stay informed with up-to-date sports news, analysis, and team updates, all in one place.' },
    ]
    return (
        <SectionLayout id={'whats-included-section'} headingText={"What's Included"}>
            <p className='font-urbanist my-10 text-center'>Maximise your returns and unlock the full range of benefits with Oakmont Athletic. Our membership is the perfect solution for punters who want convenience and results. Get access to expert insights, AI-powered betting tips, exclusive tournaments, and the latest sports news—all in one place.</p>
