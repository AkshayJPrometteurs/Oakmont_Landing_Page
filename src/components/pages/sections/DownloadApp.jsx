...
const DownloadApp = () => {
    return (
        <section id="download-app-section" className="p-10 md:px-32 md:py-16 grid grid-cols-1 md:grid-cols-2 gap-4 justify-center items-center">
            ...
            <div>
                <h1 className="uppercase text-4xl md:text-6xl text-center md:text-left font-dharma-gothic-c-italic tracking-widest font-bold">Download the new Oakmont Athletic app</h1>
