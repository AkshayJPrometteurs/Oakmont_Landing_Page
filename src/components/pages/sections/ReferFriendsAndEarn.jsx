    ...
    return (
        <section id="download-app-section" className="p-10 md:px-32 md:py-16 grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-4 justify-center items-center bg-[#F7F7F7]">
            <div>
                ...
                <p className='font-urbanist text-center md:text-left my-6 md:my-8'>All members have the opportunity to refer unlimited new members and earn up to 50% of their membership fee ongoing! It's as simple as sharing your referral code and we take care of the rest!</p>
                <div className="flex justify-center md:justify-start"><Button color="primary" className={`w-auto items-center ${inter.className}`}>Sign In to Affiliate</Button></div>
            </div>
