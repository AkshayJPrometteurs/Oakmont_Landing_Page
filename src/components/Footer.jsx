...
const Footer = () => {
    ...
    return (
        <footer className='bg-[#262626] text-white p-6 md:p-8 font-dm-sans'>
            ...
            <div className='mt-10'>
                <p className='text-center mb-4'>Download the new oakmont athletic app</p>
                <div className="flex justify-center gap-4 w-full">
                    <button className="flex items-center justify-center bg-black border border-white text-white h-14 w-44 rounded-xl">
                        <svg viewBox="0 0 384 512" width="24" className='mr-3' >
                    ...
                    <button className="flex items-center justify-center bg-black border border-white text-white h-14 w-44 rounded-xl">
                        <svg viewBox="30 336.7 120.9 129.2" width="24" className='mr-3'>
